...
export default function PackageView({ package: pkg, onBack }) {
  ...
  const handleBookNow = () => {
    const packageData = {
      ...
      image: pkg.image || "/assets/images/backwaters.jpeg",
      color: "#0ea5e9",
      rating: pkg.rating,
      reviews: pkg.reviews,
    };
  ...
  const reviews = [
    {
      ...
      date: "2024-01-15",
      comment:
        "Absolutely amazing experience! The houseboat stay was the highlight of our trip. The staff was incredibly friendly and the food was delicious.",
      verified: true,
    },
    {
      id: 2,
      ...
      date: "2024-01-10",
      comment:
        "Great package overall. The backwaters were beautiful, but I wish we had more time at each location. Would recommend for a short getaway.",
      verified: true,
    },
    {
      id: 3,
      ...
      date: "2024-01-05",
      comment:
        "Perfect honeymoon package! The private villa was romantic and the candlelight dinner was magical. Will definitely come back.",
      verified: true,
    },
  ];
                    ...
                    <div className="features-grid">
                      <div className="feature-item">
                        ...
                        <div className="feature-content">
                          ...
                          <p>
                            Stay in handpicked luxury resorts and traditional
                            houseboats
                          </p>
                        </div>
                      </div>
                      <div className="feature-item">
                        ...
                        <div className="feature-content">
                          ...
                          <p>
                            Enjoy traditional Kerala meals prepared with local
                            ingredients
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="feature-item">
                        ...
                        <div className="feature-content">
                          ...
                          <p>
                            Traditional dance performances and local village
                            visits
                          </p>
                        </div>
                      </div>
              ...
              <div className="booking-header">
                ...
                <div className="price-section">
                  ...
                  <div className="discount-badge">
                    Save ₹
                    {(
                      parseInt(pkg.originalPrice.replace(/[^0-9]/g, "")) -
