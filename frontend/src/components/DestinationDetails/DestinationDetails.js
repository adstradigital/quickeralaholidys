...
export default function DestinationDetails({ destination, onBack }) {
  ...
  const packages = destination.details?.packages || [
    { id: 1, name: "Essential Escape", slug: "essential-3d2n", days: 3, nights: 2, tag: "Most Popular" },
    { id: 2, name: "Premium Explorer", slug: "premium-5d4n", days: 5, nights: 4, tag: "Best Value" },
    { id: 3, name: "Luxury Retreat", slug: "luxury-7d6n", days: 7, nights: 6, tag: "Ultimate Luxury" }
  ];
  ...
  const images = [
    { id: 1, type: 'landscape', emoji: '🏞️' },
    { id: 2, type: 'culture', emoji: '🏛️' },
    { id: 3, type: 'adventure', emoji: '🚡' },
    { id: 4, type: 'food', emoji: '🍽️' },
    { id: 5, type: 'accommodation', emoji: '🏨' }
  ];
  ...
  // Function to get destination image or placeholder
      ...
      <section className="hero-section">
        ...
        <div className="container">
          ...
          <div className="hero-content">
            ...
            <p className="hero-description">{destination.shortDesc}</p>
            ...
            <div className="hero-actions">
              ...
              <button className="cta-button secondary">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                  <path d="M14.752 11.168L9.42 6.036a1 1 0 00-1.332.074l-.082.09a1 1 0 00.074 1.332l4.057 4.058-4.057 4.057a1 1 0 00-.074 1.332l.082.09a1 1 0 001.332.074l5.333-5.333a1 1 0 00.074-1.331l-.074-.09z" fill="currentColor"/>
                </svg>
                Watch Video
              </button>
            </div>
            ...
            <div className="content-column">
              ...
              <section className="image-gallery-section">
                <div className="gallery-header">
                  ...
                  <div className="gallery-controls">
                    <button className="gallery-nav prev" onClick={() => setActiveImage(prev => prev > 0 ? prev - 1 : images.length - 1)}>
                      ←
                    </button>
                    <button className="gallery-nav next" onClick={() => setActiveImage(prev => prev < images.length - 1 ? prev + 1 : 0)}>
                      →
                    </button>
                  </div>
                </div>
                ...
                <div className="main-gallery">
                  <div className="featured-image">
                    <div className="image-container" style={{ transform: `translateX(-${activeImage * 100}%)` }}>
              ...
              <section className="description-section">
                ...
                <p className="description-text">
                  {destination.details?.description || "Nestled in the heart of breathtaking landscapes, this destination offers an unparalleled experience for travelers seeking adventure, culture, and relaxation. From majestic mountains to pristine beaches, every moment here is a memory in the making."}
                </p>
              ...
              <section className="experiences-section">
                <div className="section-header">
                  ...
                  <span className="section-subtitle">Curated activities for every traveler</span>
                </div>
                  ...
                  {experiences.map((experience, index) => (
                    ...
                    >
                      <div className="experience-header">
                        ...
                        <div className="experience-badge" style={{ backgroundColor: experience.color }}>
                      ...
                      <div className="experience-glow" style={{ backgroundColor: experience.color }}></div>
                    </div>
                  ))}
                </div>
              </section>
            ...
            <div className="modal-content">
              <div className="package-summary">
                ...
                <div className="summary-highlight">
                  <span className="package-name">{packages.find(p => p.id === selectedPackage)?.name}</span>
                  <span className="package-duration">{packages.find(p => p.id === selectedPackage)?.days} Days • {packages.find(p => p.id === selectedPackage)?.nights} Nights</span>
                </div>
              </div>
